   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">08:51:22</td></tr>
      ...
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-09-03</td>
      <td className="wd-total-activity">14:01:32</td></tr>
      ...
      <td className="wd-total-activity">17:11:12</td></tr>
