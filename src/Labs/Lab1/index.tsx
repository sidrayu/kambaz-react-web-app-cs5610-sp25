    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Heat olive oil and butter in a skillet over medium heat.</li>
          <li>Add minced garlic and sauté until fragrant (about 30 seconds).</li>
          <li>Toss in the shrimp, season with salt and pepper, and cook for 2-3 minutes per side until pink and opaque.</li>
