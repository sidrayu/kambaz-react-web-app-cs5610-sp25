...
export default function TOC() {
  ...
  return (
    ...
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link as={Link} to="/Kambaz" id="wd-a"> Kambaz </Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link href="https://github.com/sidrayu" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
    </Nav >
  );
}
